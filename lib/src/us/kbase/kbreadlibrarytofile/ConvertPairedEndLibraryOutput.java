...
public class ConvertPairedEndLibraryOutput {
    ...
    public ConvertPairedEndLibraryOutput withFwd(String fwd) {
        this.fwd = fwd;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withRev(String rev) {
        this.rev = rev;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withInter(String inter) {
        this.inter = inter;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withSingleGenome(String singleGenome) {
        this.singleGenome = singleGenome;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withReadOrientationOutward(String readOrientationOutward) {
        this.readOrientationOutward = readOrientationOutward;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withSequencingTech(String sequencingTech) {
        this.sequencingTech = sequencingTech;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withStrain(StrainInfo strain) {
        this.strain = strain;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withSource(SourceInfo source) {
        this.source = source;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withInsertSizeMean(Double insertSizeMean) {
        this.insertSizeMean = insertSizeMean;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withInsertSizeStdDev(Double insertSizeStdDev) {
        this.insertSizeStdDev = insertSizeStdDev;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withReadCount(Long readCount) {
        this.readCount = readCount;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withReadSize(Long readSize) {
        this.readSize = readSize;
        return this;
    }
    ...
    public ConvertPairedEndLibraryOutput withGcContent(Double gcContent) {
        this.gcContent = gcContent;
        return this;
    }
