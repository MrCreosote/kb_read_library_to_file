...
async_run_methods = {}
async_check_methods = {}
async_run_methods['kb_read_library_to_file.filter_contigs_async'] = ['kb_read_library_to_file', 'filter_contigs']
async_check_methods['kb_read_library_to_file.filter_contigs_check'] = ['kb_read_library_to_file', 'filter_contigs']
sync_methods['kb_read_library_to_file.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_read_library_to_file.filter_contigs,
                             name='kb_read_library_to_file.filter_contigs',
                             types=[dict])
        self.method_authentication['kb_read_library_to_file.filter_contigs'] = 'required'
