...
function kb_read_library_to_file(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_read_library_to_file._check_job", 
            [job_id], 1, _callback, _errorCallback);
    };

    this.convert_read_library_to_file = function (params, _callback, _errorCallback, json_rpc_context) {
        if (self.async_version) {
            if (!json_rpc_context)
                json_rpc_context = {};
            json_rpc_context['service_ver'] = self.async_version;
        }
        self._convert_read_library_to_file_submit(params, function(job_id) {
    ...
    this._convert_read_library_to_file_submit = function (params, _callback, _errorCallback, json_rpc_context) {
        ...
        return json_call_ajax("kb_read_library_to_file._convert_read_library_to_file_submit", 
