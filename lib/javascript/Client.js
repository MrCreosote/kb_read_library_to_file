...
function kb_read_library_to_file(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.convert_paired_end_library_to_file = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_read_library_to_file.convert_paired_end_library_to_file",
