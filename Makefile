SERVICE = kb_read_library_to_file
SERVICE_CAPS = kb_read_library_to_file
SPEC_FILE = kb_read_library_to_file.spec
URL = https://kbase.us/services/kb_read_library_to_file
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
